                 ...
                 <div className="grid grid-cols-12 pb-6">
                    ...
                    <div className="md:col-span-6 col-span-12">
                        <div className="max-w-3xl lg:pt-40 pt-16 lg:pl-1 sm:pl-6 pl-0">
                                ...
                                <h2 className="text-white lg:text-5xl text-4xl max-w-[500px] font-semibold py-2">Disney Plus,Netflix, Spotify and More</h2>
                                <p className="text-white max-w-[616px] py-4 text-lg">Get Netflix, Disney+, Spotify, YouTube Premium Accounts with people via a safe and secured platform.
